...
import { Check, Clock, AlertTriangle, HelpCircle, Sparkles, type LucideIcon } from "lucide-react";
import { cn } from "@/lib/utils";

const ICON_MAP: Record<string, LucideIcon> = {
  Check, Clock, AlertTriangle, HelpCircle, Sparkles,
};

export interface LastVisitOption {
  icon: string;
  title: string;
  description: string;
}
...
interface Props {
  title: string;
  subtitle: string;
  options: LastVisitOption[];
  value: string;
  onChange: (v: string) => void;
}

const QuizStepLastVisit: React.FC<Props> = ({ title, subtitle, options, value, onChange }) => (
  <div>
...
export default QuizStepLastVisit;
