...
import { Sparkles, Shield, Activity, AlertTriangle, Pill, Leaf, type LucideIcon } from "lucide-react";
import { cn } from "@/lib/utils";

const ICON_MAP: Record<string, LucideIcon> = {
  Sparkles, Shield, Activity, AlertTriangle, Pill, Leaf,
};
...
const QuizStepSupplements: React.FC<Props> = ({ title, subtitle, options, value, onChange }) => (
  <div>
...
export default QuizStepSupplements;
