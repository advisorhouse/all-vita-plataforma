...
import { Smartphone, Monitor, Tv, AlertTriangle, LucideIcon } from "lucide-react";
import { cn } from "@/lib/utils";

const ICON_MAP: Record<string, LucideIcon> = {
  Smartphone, Monitor, Tv, AlertTriangle,
};
...
interface Props {
  title: string;
  subtitle: string;
  options: ScreenTimeOption[];
  value: string;
  onChange: (v: string) => void;
}

const QuizStepScreenTime: React.FC<Props> = ({ title, subtitle, options, value, onChange }) => {
  return (
    <div>
...
export default QuizStepScreenTime;
