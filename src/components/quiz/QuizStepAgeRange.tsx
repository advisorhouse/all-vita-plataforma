...
import { Zap, Activity, Heart, ShieldCheck, Sparkles, type LucideIcon } from "lucide-react";
import { cn } from "@/lib/utils";

const ICON_MAP: Record<string, LucideIcon> = {
  Zap, Activity, Heart, ShieldCheck, Sparkles,
};
...
const QuizStepAgeRange: React.FC<Props> = ({ title, subtitle, options, value, onChange }) => (
  <div>
...
export default QuizStepAgeRange;
