    ...
    <TooltipProvider delayDuration={100}>
      ...
      >
        ...
        <div className="relative h-16 border-b border-border">
          {/* Toggle button — pinned at top-right to avoid overlap with brand */}
          <button
            onClick={onToggle}
            className="absolute right-2 top-2 z-20 flex h-7 w-7 items-center justify-center rounded-lg text-muted-foreground hover:text-foreground hover:bg-secondary/60 transition-colors"
          ...
          {/* Brand area with reserved right space for toggle */}
          <div className={cn("flex h-full items-center pl-3 pr-10 overflow-hidden", collapsed ? "justify-center" : "gap-3")}>
