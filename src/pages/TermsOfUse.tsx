        ...
        <article className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-h1:text-center prose-h1:hidden">
          ...
          <section className="mb-8">
            ...
            <div className="bg-muted/30 p-4 rounded-lg border border-border">
              ...
              <p className="text-sm"><strong>Encerramento Definitivo:</strong> O encerramento pode ocorrer por iniciativa do usuário ou pela All Vita em casos de violação grave destes Termos, sem prejuízo de medidas judiciais cabíveis.</p>
            </div>
          </section>
